          ...
          <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            <AnimatePresence>
              {dashboardCards.map((card, index) => (
                ...
                >
                  <Card className="h-full transition-all duration-300 hover:shadow-lg dark:border-gray-700">
                    <div className="flex items-center justify-between p-2">
                      ...
                      <div
                        className={`rounded-lg bg-gray-100 p-3 dark:bg-gray-800 ${card.color}`}
                      >
